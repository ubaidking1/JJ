...
export const metadata: Metadata = {
  title: "Cargo Karachi to Italy | Jilani Shipping International",
  description: "Ship your cargo from Karachi to Italy (Genoa, La Spezia, Milan). Reliable sea and air freight services with complete logistics support.",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      <section className="prose max-w-none">
        <h1 className="text-4xl font-bold text-blue-900">Cargo Services Karachi to Italy</h1>
