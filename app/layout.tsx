...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "global logistics partner Pakistan",
    "international freight forwarding to all countries",
    "cross-border shipping solutions",
    "global supply chain management Karachi",
    "shipping from Pakistan to every country",
    "reliable international cargo company",
    "customs clearing agent Karachi",
    "import export documentation Pakistan",
    "sea freight rates Karachi",
    "air freight forwarding services",
    "door to door shipping international",
    "FCL and LCL shipping experts",
    "commercial cargo shipping Pakistan",
    "industrial freight forwarder",
    "best shipping company for exporters",
    "reliable customs broker Karachi",
    "supply chain logistics Pakistan",
    "freight forwarder for exporters",
    "importer logistics services Pakistan",
    "export import shipping Karachi",
    "customs agent for importers",
    "freight forwarding for international exporters",
    "reliable freight forwarder for importers",
    "importer and exporter logistics",
