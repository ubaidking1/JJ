...
export const metadata: Metadata = {
  title: "Cargo Karachi to Bangladesh | Jilani Shipping International",
  description: "Direct cargo services from Karachi to Bangladesh (Chittagong, Dhaka). Fast sea and air freight for textile and raw materials.",
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      <section className="prose max-w-none">
        <h1 className="text-4xl font-bold text-blue-900">Cargo Services Karachi to Bangladesh</h1>
